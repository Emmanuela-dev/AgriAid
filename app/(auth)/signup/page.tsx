...
const SignupPage = () => {
  ...
  // Reset loading state on mount to prevent stuck-disabled form fields
  useEffect(() => {
          ...
          <div className="w-full max-w-md mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500">
                Join AgriAid&apos;s farming community
              </p>
            </div>
        ...
        <div className="relative h-full flex flex-col justify-center items-start text-white p-20 xl:p-32">
          <div className="space-y-8 max-w-2xl">
            ...
            <h2 className="text-5xl xl:text-6xl font-black leading-tight">
              Grow Smarter, <br />
              <span className="text-green-500 underline decoration-green-500/30">Not Harder</span>
            </h2>
            <p className="text-xl text-gray-200 leading-relaxed font-light">
              AgriAid gives Kenyan farmers access to AI-powered soil analysis,
              crop recommendations, and real-time market insights — all in one
              platform.
            </p>
